package com.smoothstack.columnpartioner.model;
...
public class Transaction {
    ...
    public Transaction(Integer id, String dte, String county, String area, String number, String ttl_area, String avg_area, String ttl_trans_amt, String min_trans_amt, String max_trans_amt, String unit_price_min, String unit_price_max, String unit_price_med, String unit_price_avg, String unit_price_std, String mnth, String yar, String index) {
        this.id = id;
        this.dte = dte;
        this.county = county;
        this.area = area;
